...
use TungstenVn\Gomoku\gameHandle\createMatrix;
use TungstenVn\Gomoku\gameHandle\createDefaultMenu;
use TungstenVn\Gomoku\gameHandle\checkWin;
        ...
        if ($moveName == "Stone") {
          ...
          if ($acts[0] instanceof SlotChangeAction && $acts[1] instanceof SlotChangeAction) {
            ...
            if ($acts[0]->getInventory() instanceof InvMenuInventory && $acts[1]->getInventory() instanceof InvMenuInventory) {
              if ($mobileMoveCheck == Item::get(0, 0, 0)) {
